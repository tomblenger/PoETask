...
{	
	namespace Diagnostics
	{
		...
		public:
			...
			{
#ifdef __TEST
				int loggableItems = static_cast<int>(LogItem::Function) | static_cast<int>(LogItem::LineNumber) | static_cast<int>(LogItem::DateTime) | static_cast<int>(LogItem::LogLevel);
#else
				int loggableItems = static_cast<int>(LogItem::DateTime);
#endif
				m_level = LogLevel::Info;
				m_name = _T("AuthServer");
				m_loggableItem = loggableItems;
			}
